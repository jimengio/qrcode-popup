...
import DemoUseZxingScanner from "./demo-use-zxing-scanner";
...
let items: ISidebarEntry[] = [
  ...
  {
    title: "useZxingScanner",
    path: genRouter.useZxingScanner.name,
  },
...
const renderChildPage = (routerTree: GenRouterTypeMain) => {
  switch (routerTree?.name) {
    ...
    case "use-zxing-scanner":
      return <DemoUseZxingScanner />;
